...
INSERT INTO product (id, name, main_category, sub_category, description, url, order_weight, score, main_image, created_at, updated_at)
SELECT id, null, main_category, sub_category, description, url, order_weight, score, main_image, created_at, updated_at
FROM temp_product;
